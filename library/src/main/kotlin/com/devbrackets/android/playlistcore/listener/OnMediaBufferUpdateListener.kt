 ...
 */
interface OnMediaBufferUpdateListener {
    /**
     ...
     */
    fun onBufferingUpdate(mediaPlayerApi: MediaPlayerApi, @IntRange(from = 0, to = MediaProgress.MAX_BUFFER_PERCENT.toLong()) percent: Int)
}
