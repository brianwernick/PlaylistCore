...
interface MediaStatusListener {
     ...
     */
    fun onPrepared(mediaPlayer: MediaPlayerApi)
     ...
     */
    fun onBufferingUpdate(mediaPlayer: MediaPlayerApi, @IntRange(from = 0, to = MediaProgress.MAX_BUFFER_PERCENT.toLong()) percent: Int)
     ...
     */
    fun onSeekComplete(mediaPlayer: MediaPlayerApi)
     ...
     */
    fun onCompletion(mediaPlayer: MediaPlayerApi)
     ...
     */
    fun onError(mediaPlayer: MediaPlayerApi): Boolean
}