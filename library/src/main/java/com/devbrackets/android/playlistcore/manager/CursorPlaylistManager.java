...
/**
 * An implementation of the {@link PlaylistManager} that supports Cursors
 */
@SuppressWarnings("unused")
public abstract class CursorPlaylistManager<I extends IPlaylistItem> extends PlaylistManager<I> {
    @Nullable
